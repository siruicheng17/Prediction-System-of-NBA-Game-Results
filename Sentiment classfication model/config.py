...
class Options():
    def __init__(self):
        ...
        parser.add_argument("--train_path", type=str, default="data/dev2.txt", help="path of training set")
        parser.add_argument("--val_path", type=str, default="data/dev2.txt", help="path of val set")
        ...
        # training rounds setting.
        parser.add_argument("--num_epochs", type=int, default=5, metavar="N", help="number of epochs to train")
